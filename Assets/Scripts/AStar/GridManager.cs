...
namespace DuncFortress.AStar
{
    ...
    public class GridManager : MonoBehaviour
    {
        ...
        public bool IsInBounds(Vector3 pos)
        {
            ...
            return (pos.x >= Origin.x && pos.x <= Origin.x + width && pos.x <= Origin.y + height && pos.y >= Origin.y);
        }
        ...
        public bool isAtGoal(Vector3 origin, Vector3 endPos)
        {
            if (origin == endPos)
                return true;
            else
        ...
        public GoalEvaluator isAtGoal2(Node endNode)
        {
